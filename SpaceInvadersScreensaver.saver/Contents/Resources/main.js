// Space Invaders – screensaver build (FIXED)
// - Coordenadas en CSS px (NO se multiplica todo por DPR)
// - Canvas escalado con ctx.setTransform(DPR,...)
// - Assets locales con baseURL (lo maneja Swift)
// - Arranca aunque falle 1 sprite (allSettled)
...
(() => {
  ...
  Promise.allSettled([
    ...
    if (!images.Ship || !images.InvaderA || !images.InvaderB) {
      ...
      ctx.fillText("Faltan sprites en assets/ (Ship/InvaderA/InvaderB).", 30, 60);
      return;
    }
